# Field Manual - Risk Assessment for Thermal Processes in Food Manufacture

This is the dense working reference for `book-thermal-process-risk-food-manufacture`. It is a derived guide for AutoHAZOP use, not a reproduction of the source. Use it to ask sharper questions, reject weak worksheet logic, and produce evidence-aware recommendations.
...
- Pages: 44
- Usable text pages indexed: 44
- Indexed text characters: 119687
...
|---:|---:|---|---|
| 29 | 2 | hazop_pha | Use as a source-navigation anchor; verify before numeric/design claims. |
| 12 | 1 | qra_risk | Use as a source-navigation anchor; verify before numeric/design claims. |

## Topic Capsules

- HAZOP/PHA: Improve node intent, guide-word deviation quality, cause/consequence wording, safeguards, and recommendation discipline. Evidence pages: 29. Treat these pages as navigation anchors, not final proof.
- QRA/risk criteria: Challenge frequency, consequence, risk criteria, event-tree/fault-tree assumptions, and uncertainty treatment. Evidence pages: 12. Treat these pages as navigation anchors, not final proof.
