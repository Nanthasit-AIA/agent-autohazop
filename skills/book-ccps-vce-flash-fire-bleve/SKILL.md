---
name: book-ccps-vce-flash-fire-bleve
description: Use source-specific working knowledge from CCPS VCE, Flash Fire and BLEVE Characteristics for AutoHAZOP, HAZOP/PHA, LOPA, SIS, QRA, relief/consequence, reliability, PSM, incident-learning, alarm, or process-safety review when a node, deviation, safeguard, recommendation, or user question matches these tags: vce, flash-fire, bleve, overpressure, thermal-radiation, consequence. Use to improve scenario framing, missing-basis detection, evidence-traceable recommendations, and specialist handoff. Read references/wiki.md, references/field-manual.md, and references/evidence-map.md before substantive use.
---

# CCPS VCE, Flash Fire and BLEVE Characteristics Book Skill

Use this skill to apply the `ccps-vce-flash-fire-bleve` book wiki as a controlled AutoHAZOP working method. This skill is intentionally fail-closed: if a value, table, criterion, equation, example, or plant-specific fact is not encoded in the wiki/evidence map or supplied by project data, mark it as missing basis instead of guessing.
...
- Top evidence signals: Fire/explosion:683, Relief/effluent:248, Consequence analysis:149, Incident/human factors:56
...
- Basis: `ccps-vce-flash-fire-bleve`, matched evidence signal, source role, and confidence tier.
