---
name: book-bs-en-1861-refrigerating-pid-layout-symbols
description: Use source-specific working knowledge from BS EN 1861 Refrigerating Systems Flow Diagrams and P&ID Layout/Symbols for AutoHAZOP, HAZOP/PHA, LOPA, SIS, relief/consequence, reliability, PSM, operations, maintenance, P&ID/graph extraction, or process-safety review when a node, deviation, cause, safeguard, recommendation, or user question matches these tags: bs-en-1861, refrigeration, heat-pump, p&id-symbols, flow-diagram. Use to sharpen cause credibility, consequence paths, safeguard/IPL classification, missing-basis detection, and verifiable recommendations. Read references/wiki.md, references/field-manual.md, and references/evidence-map.md before substantive use.
---

# BS EN 1861 Refrigerating Systems Flow Diagrams and P&ID Layout/Symbols Book Skill

Use this skill as a controlled AutoHAZOP working method for `bs-en-1861-refrigerating-pid-layout-symbols`. This is intentionally fail-closed: if a value, table, equation, clause, acceptance criterion, inspection interval, proof-test basis, or project fact is not encoded in the wiki/evidence map or supplied by project data, mark it as missing basis instead of guessing.
...
4. If detailed standard-derived context is needed and available, read `autohazop-agent-pack/references/standards/bs-en-1861-refrigerating-pid-layout-symbols.md`.
...
- Primary topic wiki: `pid-reading-symbols`
...
- Core decision lens: Use refrigeration/heat-pump diagram conventions to improve P&ID symbol/layout extraction and prevent node/topology mistakes.
...
- Basis: `bs-en-1861-refrigerating-pid-layout-symbols`, matched tag/domain, source role, and confidence tier.
