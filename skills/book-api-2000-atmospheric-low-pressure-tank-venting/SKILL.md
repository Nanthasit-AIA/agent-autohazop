---
name: book-api-2000-atmospheric-low-pressure-tank-venting
description: Use source-specific working knowledge from API 2000 Atmospheric and Low-Pressure Tank Venting for AutoHAZOP, HAZOP/PHA, LOPA, SIS, relief/consequence, reliability, PSM, operations, maintenance, P&ID/graph extraction, or process-safety review when a node, deviation, cause, safeguard, recommendation, or user question matches these tags: api-2000, tank-venting, inbreathing, outbreathing, blanketing, emergency-vent. Use to sharpen cause credibility, consequence paths, safeguard/IPL classification, missing-basis detection, and verifiable recommendations. Read references/wiki.md, references/field-manual.md, and references/evidence-map.md before substantive use.
---

# API 2000 Atmospheric and Low-Pressure Tank Venting Book Skill

Use this skill as a controlled AutoHAZOP working method for `api-2000-atmospheric-low-pressure-tank-venting`. This is intentionally fail-closed: if a value, table, equation, clause, acceptance criterion, inspection interval, proof-test basis, or project fact is not encoded in the wiki/evidence map or supplied by project data, mark it as missing basis instead of guessing.
...
4. If detailed standard-derived context is needed and available, read `autohazop-agent-pack/references/standards/api-2000-atmospheric-low-pressure-tank-venting.md`.
...
- Domain: `tank-venting`
- Primary topic wiki: `tank-venting`
- Primary shared skill: `relief-effluent-fire-explosion-consequence`
- Secondary shared skills: none
- Detailed standard reference: `autohazop-agent-pack/references/standards/api-2000-atmospheric-low-pressure-tank-venting.md`
...
- Core decision lens: Use API 2000 venting context to challenge tank overpressure/vacuum, inbreathing/outbreathing, blanketing, vapor recovery, flame arrester, and emergency vent assumptions.
...
- Basis: `api-2000-atmospheric-low-pressure-tank-venting`, matched tag/domain, source role, and confidence tier.
