---
name: book-api-650-welded-tanks-oil-storage
description: Use source-specific working knowledge from API 650 Welded Tanks for Oil Storage for AutoHAZOP, HAZOP/PHA, LOPA, SIS, relief/consequence, reliability, PSM, operations, maintenance, P&ID/graph extraction, or process-safety review when a node, deviation, cause, safeguard, recommendation, or user question matches these tags: api-650, storage-tank, floating-roof, anchorage, foundation, nozzle. Use to sharpen cause credibility, consequence paths, safeguard/IPL classification, missing-basis detection, and verifiable recommendations. Read references/wiki.md, references/field-manual.md, and references/evidence-map.md before substantive use.
---

# API 650 Welded Tanks for Oil Storage Book Skill

Use this skill as a controlled AutoHAZOP working method for `api-650-welded-tanks-oil-storage`. This is intentionally fail-closed: if a value, table, equation, clause, acceptance criterion, inspection interval, proof-test basis, or project fact is not encoded in the wiki/evidence map or supplied by project data, mark it as missing basis instead of guessing.
...
4. If detailed standard-derived context is needed and available, read `autohazop-agent-pack/references/standards/api-650-welded-tanks-oil-storage.md`.
...
- Domain: `tank-design`
- Primary topic wiki: `tank-design-storage`
- Primary shared skill: `inherently-safer-siting-layout`
- Secondary shared skills: none
- Detailed standard reference: `autohazop-agent-pack/references/standards/api-650-welded-tanks-oil-storage.md`
...
- Core decision lens: Use API 650 tank design context to challenge atmospheric storage tank design envelope, roof, anchorage, nozzles, foundation, overflow, and settlement assumptions.
...
- Basis: `api-650-welded-tanks-oil-storage`, matched tag/domain, source role, and confidence tier.
