...
5. Route to shared skill `lopa-iel-conditional-modifier` and secondary skills `reliability-data-selection` when the decision needs a specialist workflow.
...
- Top evidence signals: LOPA/IPL:1326, SIS/SIL:336, Relief/effluent:336, Reliability data:309
...
- Basis: `ccps-initiating-events-ipls-lopa`, matched evidence signal, source role, and confidence tier.
